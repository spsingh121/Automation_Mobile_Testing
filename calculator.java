...
public class calculator {
    public static void main(String[] args) throws MalformedURLException {
        ...
        var el1 = ad.findElement(AppiumBy.id("com.android.calculator2:id/digit_5"));
        el1.click();
        var el2 = ad.findElement(AppiumBy.accessibilityId("plus"));
        el2.click();
        var el3 = ad.findElement(AppiumBy.id("com.android.calculator2:id/digit_4"));
        el3.click();
        var el4 = ad.findElement(AppiumBy.accessibilityId("equals"));
        el4.click();
        ...
        //Assert.assertEquals(ad.findElement(AppiumBy.id("com.android.dialer:id/result")).getText(),"9");
